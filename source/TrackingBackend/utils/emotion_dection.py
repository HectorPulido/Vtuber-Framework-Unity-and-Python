...
from emotion_models.emotion_model import EmotionModel
from emotion_models.grad_cam import BackPropagation

class EmotionDetector():
    faceCascade = cv2.CascadeClassifier('emotion_models/haarcascade_frontalface_default.xml')
    shape = (48,48)
    classes = [
        'Angry',
        'Disgust',
    ...
    def __init__(self, model_name='checkpoints/private_model_233_66.t7', gpu=True):
